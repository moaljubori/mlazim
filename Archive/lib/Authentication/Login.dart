...
Container(
height: 120,
margin: LangSet? const EdgeInsets.only(left: 250) : const EdgeInsets.only(right: 250),
...
//Button Input RestPassword ^^^^^^^^^^^^^^^^^^^^^^^^^^
            SizedBox(
              ...
              child: GestureDetector(
                ...
                onTap: () => Navigator.pushNamedAndRemoveUntil(context, "/ForgotPassword", (r) => false),
                child: Text(
                  'Forget Password'.tr,
...
api_website + 'ServerApi/login.php?email=' + _Email.text + '&password=' +  _Password.text,
);
...
child: ListBody(
children: <Widget>[Text("Please try again!!".tr),],
),
),
actions: <Widget>[
TextButton(child: Text('Returnx'.tr),
            ...
            SizedBox(
              ...
              child: Row(
                ...
                children: [
                  ...
                  GestureDetector(
                    onTap: () => Navigator.pushNamedAndRemoveUntil(context, "/CreateAccount", (r) => false) ,
                    child: Text(
