...
//TextEditingController  --------------- ^^^^^^^^^^^^^^^
 late String _type = '';
  ...
  {'value': 'Class One Primary'.tr,     'label': 'Class One Primary'.tr,    },
  {'value': 'Class Tow Primary'.tr,     'label': 'Class Tow Primary'.tr,    },
  {'value': 'Class Three Primary'.tr,   'label': 'Class Three Primary'.tr,  },
  {'value': 'Class Four Primary'.tr,    'label': 'Class Four Primary'.tr,   },
  {'value': 'Class Five Primary'.tr,    'label': 'Class Five Primary'.tr,   },
  {'value': 'Class Six Primary'.tr,     'label': 'Class Six Primary'.tr,    },
  {'value': 'Class One Middle'.tr,      'label': 'Class One Middle'.tr,     },
  {'value': 'Class Tow Middle'.tr,      'label': 'Class Tow Middle'.tr,     },
  {'value': 'Class Three Middle'.tr,    'label': 'Class Three Middle'.tr,   },
  {'value': 'Class Four Scintific'.tr,  'label': 'Class Four Scintific'.tr, },
  {'value': 'Class Four Literary'.tr,   'label': 'Class Four Literary'.tr,  },
  {'value': 'Class Five Literary'.tr,   'label': 'Class Five Literary'.tr,  },
  {'value': 'Class Five Biology'.tr,    'label': 'Class Five Biology'.tr,   },
  {'value': 'Class Five Applied'.tr,    'label': 'Class Five Applied'.tr,   },
  {'value': 'Class Six Applied'.tr,     'label': 'Class Six Applied'.tr,    },
  {'value': 'Class Six Commercial'.tr,  'label': 'Class Six Commercial'.tr, },
  {'value': 'Class Six Literary'.tr,    'label': 'Class Six Literary'.tr,   },
  {'value': 'Class Six Biology'.tr,     'label': 'Class Six Biology'.tr,    },
                      ...
                      onPressed: () async {
                              ...
                              if (_details.text != '') {
                                if (prefs.getString('StateUserLogin') == '1') {
                                    ...
                                    showDialog<void>(
                                      ...
                                      builder: (BuildContext context) {
                                        return AlertDialog(
                                          ...
                                          title: Text("Thank You!".tr  ,  textAlign: TextAlign.center,),
                                          content: SingleChildScrollView(
                                            child: ListBody(
                                              children: <Widget>[
                                                Text('Your_suggestion'.tr ,  textAlign: TextAlign.center,),
                                              ],
                                            ),
                                          ),
                                          actions: <Widget>[
                                  ...
                                  showDialog<void>(
                                    ...
                                    builder: (BuildContext context) {
                                      return AlertDialog(
                                        title:
                                            Text('You_are_not_registered'.tr ,  textAlign: TextAlign.center,),
                                        content: SingleChildScrollView(
                                          child: ListBody(
                                            children: <Widget>[
                                              Text(
                                                  'Please_log_in_to_the_application'
                                ...
                                showDialog<void>(
                                  ...
                                  builder: (BuildContext context) {
                                    return AlertDialog(
                                      title: Text("Oops!".tr,  textAlign: TextAlign.center,),
 
                                      content: SingleChildScrollView(
                                        child: ListBody(
                                          children: <Widget>[
                                            Text('The_information_must'.tr ,  textAlign: TextAlign.center,),
                                          ],
                                        ),
                                      ),
                                      actions: <Widget>[
