...
class _TitlePagesState extends State<TitlePages> {
  ...
  Widget build(BuildContext context) {
    return Container(
      padding: LangSet? const EdgeInsets.only(right: 15):const EdgeInsets.only(left: 15),
      height: 40,
      child: Stack(
        children: <Widget>[
          Positioned(
          ...
          Container(
            padding: LangSet? const EdgeInsets.only(right: 15) : const EdgeInsets.only(left: 20),
            child: Text(
              BuildName,
              style: TextStyle(
                  fontSize: 20,
...
class BookCard extends StatefulWidget {
  ...
  const BookCard({
    ...
    required this.views,
    required this.color,
    required this.img, required this.pdf,
     required this.id, required this.Type, required this.fav,
  }) : super(key: key);
}
...
Column(
children: [
Image.network(img,fit: BoxFit.fill,width: 200,
),
...
borderRadius: BorderRadius.circular(7)),
 margin: LangSet? const EdgeInsets.only(right: 10):const EdgeInsets.only(left: 10),
 padding: LangSet? const EdgeInsets.only(right: 7):const EdgeInsets.only(left: 7),
width: 85,
child: Row(children: [
Expanded(
child: Text(
widget.views,style: const TextStyle(color: Colors.black),
)),
const Expanded(child: Icon(Icons.visibility,color: Colors.black,))
]))),
...
crossAxisAlignment:CrossAxisAlignment.center,
children: [
Text('Read'.tr,style: const TextStyle(fontWeight:FontWeight.normal,)),
const Icon(Icons.arrow_forward_ios,size: 15)]
),
)),
...
AlartRate(widget.name , widget.id , widget.Type , widget.img);
} else {

showDialog(
builder: (context) =>
CupertinoAlertDialog(title: Column(
children: <Widget>[Text("Oops!".tr),
...
crossAxisAlignment:CrossAxisAlignment.center,
children: [
Text('Rate'.tr,style: const TextStyle(fontWeight:FontWeight.normal,)),
const Icon(Icons.arrow_forward_ios,size: 15)
]),
)),
                                    ]),
...
boxShadow: [
BoxShadow(color: Colors.black.withOpacity(.2), blurRadius: 30.0)],
color: Colors.white,
),
width: 45,
height: 45,
...
class VideoCard extends StatefulWidget {
  ...
  const VideoCard({
    ...
    required this.views,
    required this.color,
    required this.img, required this.Link, required this.id, required this.fav, 
  }) : super(key: key);
}
